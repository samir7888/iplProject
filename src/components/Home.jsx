...
//   console.log(filterData)
  ...
  return (
    <>
    <div className='w-[100%] md:w-[60%]  mx-auto grid grid-cols-1 gap-3 p-4  md:grid-cols-2  text-white  bg-opacity-20'>
     ...
     
        {
          matchesData.map(({matchDetailsMap : {match,key : date}})=>(
              match.map((
                ...
                {matchInfo:{team1 :{teamSName : team1Name,imageId : team1Img},team2:{teamSName : team2Name,imageId : team2Img},status,matchId,matchDesc},
                
                matchScore}
                ,i) => (
                <Link key={i} to={`/matchDetail/${matchId}`} >

                  {/* <h1 >{team1Name} VS {teamSName},{date},{status}</h1> */}
                  <div className='min-w-full min-h-32  md:h-[135px] bg-[#303134]   border p-3 rounded-md '>
                    ...
                    <div>
                        <div className='flex justify-between'>
                            ...
                            <img className='w-4 object-contain' src={'https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/'+team1Img} alt="" />
                            <p>{team1Name}</p>
                            </div>
                            {
                                matchScore?.team1Score ?
                                <p>{matchScore?.team1Score?.inngs1?.runs}/{matchScore?.team1Score?.inngs1?.wickets} ({matchScore?.team1Score?.inngs1?.overs})</p>:<p></p>
                            }
                        </div>
                        <div className='flex justify-between'>
                            <div className='flex gap-2'>

                        <img className='w-4 object-contain' src={'https://res.cloudinary.com/digkgdovw/image/upload/v1715267650/iplTeamLogo/'+team2Img} alt="" />
                            <p>{team2Name}</p>
                            </div>
                            {
                                 matchScore?.team1Score ?
